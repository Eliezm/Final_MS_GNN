(define (problem logistics-small-0)
  (:domain logistics)
  (:objects
  ...
  (:goal (and
    (at-obj pkg0 loc-city1-0) (at-obj pkg1 loc-city1-0) (at-obj pkg2 loc-city1-0) (at-obj pkg3 loc-city1-0) (at-obj pkg4 loc-city1-0)
  ))
)
