(define (problem logistics-small-1)
  (:domain logistics)
  (:objects
  ...
  (:goal (and
    (at-obj pkg0 loc-city0-0) (at-obj pkg1 loc-city0-0) (at-obj pkg2 loc-city0-0) (at-obj pkg3 loc-city0-0) (at-obj pkg4 loc-city0-0)
  ))
)
