...
// ============================================================================
// FEATURE DIMENSIONS - UPDATED FOR ENHANCED FEATURES
// ============================================================================

constexpr int NODE_FEATURE_DIM = 20;    // EXPANDED: 15 → 20 (5 new features)
constexpr int EDGE_FEATURE_DIM = 15;    // EXPANDED: 10 → 15 (5 new features)
 ...
 * Now includes 15-dim edge features computed in C++
 */
...
/**
 * Compute enhanced 20-dimensional node features
 *
 * Features 0-14: Original features
 * Features 15-19: New structural and analysis features
 */
...
/**
 * Compute 15-dim edge features for a merge candidate pair
 *
 * Returns 15 features including:
 * - Label synchronization (Jaccard, shared ratio, sync factor)
 * - Product size estimates
 * - Variable relationships
 * - Heuristic quality
 * - Structural compatibility
 * - CRITICAL NEW: Operator projection, label combinability, GB error, etc.
 */
